      ...
      <div className='bg-[#E8F5E9] w-full h-[500px]'>
        <div className='container flex justify-between'>
          <div className="text inline-block mt-[100px]">
            ...
            <p className='text-base lato_font font-medium text-[#4b4949] mt-[20px] w-[644px] leading-7'>Hi, I am a professional Frontend Developer & web designer with 3 years experience, I provide html, 
            ...
            <button className="text-base lato_font font-bold px-[20px] py-[12px] rounded-xl bg-[#4CAF50] mt-[20px]" type="button">Resume Downloade</button>
          </div>
